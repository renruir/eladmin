...
public class Insulation implements Serializable {
    ...
    @Column(name = "setting_voltage")
    @ApiModelProperty(value = "settingVoltage")
    private String settingVoltage;

    @Column(name = "setting_current")
    @ApiModelProperty(value = "settingCurrent")
    private String settingCurrent;

    @Column(name = "setting_time")
    @ApiModelProperty(value = "settingTime")
    private String settingTime;

    @Column(name = "area1")
    @ApiModelProperty(value = "area1")
    private String area1;

    @Column(name = "area2")
    @ApiModelProperty(value = "area2")
    private String area2;

    @Column(name = "area3")
    @ApiModelProperty(value = "area3")
    private String area3;

    @Column(name = "area4")
    @ApiModelProperty(value = "area4")
    private String area4;

    @Column(name = "area5")
    @ApiModelProperty(value = "area5")
    private String area5;

    @Column(name = "area6")
    @ApiModelProperty(value = "area6")
    ...
    public void copy(Insulation source){
