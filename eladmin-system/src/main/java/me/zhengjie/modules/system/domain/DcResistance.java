...
@Entity
@Data
@Table(name="inspect_dc_resistance")
public class DcResistance implements Serializable {
    ...
    @Column(name = "m_resistance")
    @ApiModelProperty(value = "mResistance")
    private String mResistance;

    @Column(name = "e_resistance")
    @ApiModelProperty(value = "eResistance")
    private String eResistance;

    @Column(name = "fenjie_position")
    @ApiModelProperty(value = "fenjiePosition")
    private String fenjiePosition;

    @Column(name = "m_phase")
    @ApiModelProperty(value = "mPhase")
    ...
    public void copy(DcResistance source){
